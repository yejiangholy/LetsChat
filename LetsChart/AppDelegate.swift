...
class AppDelegate: UIResponder, UIApplicationDelegate, CLLocationManagerDelegate {
    ...
    //set up plist to get location to get location working 

    var locationManager: CLLocationManager?
    var coordinate: CLLocationCoordinate2D?
    
    let APP_ID = "598BB9C8-3D6D-14C9-FF0C-D31D02EAB000"
    let SECRET_KEY = "5144FD04-B72A-4D91-FFE8-88785893A300"
    let VERSION_NUM = "v1"
    ...
    func application(application: UIApplication, didFailToRegisterForRemoteNotificationsWithError error: NSError) {
        ...
        print("could't register for notification : \(error)")
        
    }
    //MARK: LoacationaManager functions 
    ...
    //MARK: CLLlocationManager Delegate 
